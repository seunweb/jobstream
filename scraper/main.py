"""
JobStream API - Complete with Authentication
FastAPI server with scraping, jobs, applications, and auth endpoints.
"""
...
app = FastAPI(title="JobStream API", version="0.2.0", lifespan=lifespan)
