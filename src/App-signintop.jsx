          ...
          {user ? (
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <div style={{ textAlign: "right" }}>
                <div style={{ fontSize: 12, fontWeight: 600, color: isDark ? "#e0e0e0" : "#1d1d1f" }}>{user.full_name}</div>
                <div style={{ fontSize: 10, color: isDark ? "#666" : "#999" }}>{user.email}</div>
              </div>
              <button
                onClick={handleLogout}
                style={{ background: "none", border: isDark ? "1px solid #2a2a32" : "1px solid #d0d0d8", borderRadius: 8, padding: "6px 14px", fontSize: 12, color: isDark ? "#888" : "#555", cursor: "pointer", fontFamily: "'DM Sans', sans-serif", whiteSpace: "nowrap" }}
              >
                Sign out
              </button>
            </div>
            ...
            <button
              ...
              style={{ background: "#0071E3", border: "none", borderRadius: 8, padding: "8px 18px", fontSize: 13, fontWeight: 600, color: "#fff", cursor: "pointer", fontFamily: "'DM Sans', sans-serif", boxShadow: "0 2px 8px rgba(0,113,227,0.3)" }}
            >
              Sign in
            </button>
          )}
